...
def segment_audio(audio_path, min_silence_len=1000, silence_thresh=-40, skip_initial=0):
    ...
    # Define a subdirectory called "segmented-chunks"
    output_dir = os.path.join(input_dir, "segmented-chunks")
